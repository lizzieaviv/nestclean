#' nestclean: A Package for Checking NEST Lab Data Cleaning Projects
#'
#' The `nestclean` package provides tools to check and summarize the outcome of data cleaning for the NEST lab.
#'
